...
class AWSDeploymentAgent:
    ...
    async def deploy_application(self, project_id: str, deployment_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _deploy_to_ecs(self, project_id: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _deploy_to_lambda(self, project_id: str, config: Dict[str, Any]) -> Dict[str, Any]:
        """Deploy application as Lambda functions."""
        try:
            app_name = f"{project_id}-lambda"

            # 1. Create deployment package
            deployment_package = await self._create_lambda_package(config.get('code_files', {}))
    ...
    async def _deploy_to_beanstalk(self, project_id: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def get_deployment_status(self, project_id: str, deployment_type: str) -> Dict[str, Any]:
        ...
        try:
            if deployment_type == 'ecs':
                ...
                return {"status": "unknown", "error": f"Unknown deployment type: {deployment_type}"}
    ...
    async def _get_ecs_status(self, project_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "deployment_status": service.get('deploymentConfiguration', {}).get('deploymentStatus', 'unknown')
            }
    ...
    async def cleanup_deployment(self, project_id: str, deployment_type: str) -> Dict[str, Any]:
    ...
    async def _cleanup_lambda_deployment(self, project_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "message": f"Lambda function {function_name} deleted"}
